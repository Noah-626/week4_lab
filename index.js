...
// Query Parameters
// http://localhost:3000/user?firstname=Noah&lastname=blue
app.get('/user', (req, res) => {
    ...
    if(req.query.firstname === undefined || req.query.lastname === undefined) {
        const error = {
            status: false,
            message: 'please specify firstname and lastname query parameters'
        }
        res.send(error);
    } else {
...
// http://localhost:3000/products/firstname/lastname
